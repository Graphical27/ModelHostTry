...
# If Yield not available, compute it from Production / Area
...
categorical_transformer = Pipeline(steps=[
    ...
    # In sklearn 1.6.1 use sparse_output instead of sparse
